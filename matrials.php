...
if (isset($_GET['id'])) {
  $id=$_GET['id'];
    $query="SELECT * FROM materials WHERE class_num=".$id;
           ...
           <div class="col-md-4">
              <div class="card mt-3" style="background: #ced4da;">
                     <div class="product-1 algin-items-center p-2 text-center">
                      <a class="btn" href="files.php?id=<?php echo $row['material_id'];?>">
                       ...
                       <!--card Informations-->
                       <div class="mr-3 info">
                         <span class="text1 d-block"><?php echo $row['material_information'];?></span>
                       </div>
                     </div>
